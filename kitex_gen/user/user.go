...
func (p *GetUserReq) Field2DeepEqual(src int64) bool {
...
func (p *MGetUserReq) GetUserId() (v int64) {
	return p.UserId
}
func (p *MGetUserReq) SetIdList(val []int64) {
	p.IdList = val
}
func (p *MGetUserReq) SetUserId(val int64) {
	p.UserId = val
}
...
func (p *MGetUserReq) Field2DeepEqual(src int64) bool {
