...
func (x *DouyinFeedResponse) fastReadField5(buf []byte, _type int8) (offset int, err error) {
	tmp, offset, err := fastpb.ReadInt64(buf, _type)
	x.NextTime = &tmp
	return offset, err
}
...
func (x *DouyinFeedResponse) fastWriteField3(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 3, *x.StatusMsg)
	return offset
}
...
func (x *DouyinFeedResponse) fastWriteField5(buf []byte) (offset int) {
	if x.NextTime == nil {
		return offset
	}
	offset += fastpb.WriteInt64(buf[offset:], 5, *x.NextTime)
	return offset
}
...
func (x *DouyinFeedResponse) sizeField3() (n int) {
	...
	n += fastpb.SizeString(3, *x.StatusMsg)
	return n
}
...
func (x *DouyinFeedResponse) sizeField5() (n int) {
	if x.NextTime == nil {
		return n
	}
	n += fastpb.SizeInt64(5, *x.NextTime)
	return n
}
