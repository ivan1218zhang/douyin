...
type DouyinFeedResponse struct {
	...
	NextTime   *int64    `protobuf:"varint,5,opt,name=next_time,json=nextTime,proto3,oneof" json:"next_time,omitempty"`   // 本次返回的视频中，发布最早的时间，作为下次请求时的latest_time
}
...
var file_video_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x70, 0x0a, 0x13, 0x64,
	...
	0x69, 0x6d, 0x65, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xf5, 0x01,
	...
	0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x88, 0x01, 0x01, 0x12, 0x2b, 0x0a, 0x0a, 0x76, 0x69, 0x64,
	0x65, 0x6f, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e,
	...
	0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x48, 0x01, 0x52, 0x08, 0x6e, 0x65, 0x78,
	...
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x22, 0xf7, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12,
	...
	0x74, 0x32, 0x55, 0x0a, 0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x45, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x1a, 0x2e,
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x65, 0x65,
	0x64, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x76, 0x69, 0x64, 0x65,
	0x6f, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x72, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x1c, 0x5a, 0x1a, 0x64, 0x6f, 0x75, 0x79,
	0x69, 0x6e, 0x2f, 0x69, 0x64, 0x6c, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78, 0x5f, 0x67, 0x65, 0x6e,
...
var file_video_proto_goTypes = []interface{}{
	...
	(*DouyinFeedRequest)(nil),  // 1: video.douyin_feed_request
	(*DouyinFeedResponse)(nil), // 2: video.douyin_feed_response
	(*Video)(nil),              // 3: video.Video
	(*User)(nil),               // 4: video.User
}
var file_video_proto_depIdxs = []int32{
	0, // 0: video.douyin_feed_response.base_resp:type_name -> video.BaseResp
	3, // 1: video.douyin_feed_response.video_list:type_name -> video.Video
	4, // 2: video.Video.author:type_name -> video.User
	1, // 3: video.VideoService.GetVideo:input_type -> video.douyin_feed_request
	2, // 4: video.VideoService.GetVideo:output_type -> video.douyin_feed_response
...
type VideoService interface {
	GetVideo(ctx context.Context, req *DouyinFeedRequest) (res *DouyinFeedResponse, err error)
}
